...
import createClient from '../../__tests__/utils/createClient';
import { SAMPLE_TASKS } from '../../__tests__/utils/data';
import noop from '../../__tests__/utils/noop';
import wait from '../../__tests__/utils/wait';
...
it('should return the query data', async () => {
  ...
  const { container } = render(<TasksWrapper client={client} query={TASKS_QUERY} />);
...
it('should accept a client option', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper query={TASKS_QUERY} client={client} />);
...
it('should work with suspense enabled', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper client={client} query={TASKS_QUERY} suspend />);
...
it.each([false, true])('should support query variables with with "suspend: %s"', async suspend => {
  const client = createMockClient();
...
it('should support updating query variables without suspense', async () => {
  ...
  const { container, rerender } = render(
    <TasksWrapper client={client} query={FILTERED_TASKS_QUERY} variables={{ completed: true }} />
  );
...
`);
  ...
  rerender(<TasksWrapper client={client} query={FILTERED_TASKS_QUERY} variables={{ completed: false }} />);
...
`);
  ...
  rerender(<TasksWrapper client={client} query={FILTERED_TASKS_QUERY} variables={{ completed: true }} />);
...
it('should support updating query variables with suspense', async () => {
  const client = createMockClient();
  const { container, rerender } = render(
    <TasksWrapper client={client} query={FILTERED_TASKS_QUERY} suspend variables={{ completed: true }} />
  );
...
`);
  ...
  rerender(
    <TasksWrapper client={client} query={FILTERED_TASKS_QUERY} suspend variables={{ completed: false }} />
  );
...
it('skips query in suspense mode', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper client={client} skip query={TASKS_QUERY} />);
...
it('skips query in non-suspense mode', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper client={client} skip suspend={false} query={TASKS_QUERY} />);
...
it('starts skipped query in suspense mode', async () => {
  const client = createMockClient();
  const { rerender, container } = render(<TasksWrapper client={client} query={TASKS_QUERY} skip suspend />);
...
`);
  ...
  rerender(<TasksWrapper client={client} query={TASKS_QUERY} skip={false} suspend />);
...
`);
  ...
  rerender(<TasksWrapper client={client} skip={false} suspend={false} query={TASKS_QUERY} />);
...
it('handles network error in suspense mode', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper suspend client={client} query={NETWORK_ERROR_QUERY} />);
...
it('handles network error in non-suspense mode', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper suspend={false} client={client} query={NETWORK_ERROR_QUERY} />);
...
it('handles GraphQL error in suspense mode', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper suspend client={client} query={GRAPQHL_ERROR_QUERY} />);
...
it('handles GraphQL error in non-suspense mode', async () => {
  const client = createMockClient();
  const { container } = render(<TasksWrapper suspend={false} client={client} query={GRAPQHL_ERROR_QUERY} />);
