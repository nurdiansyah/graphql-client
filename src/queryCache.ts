...
const cachedQueriesByClient = new WeakMap<ApolloClient<any>, Map<any, ObservableQuery<any, any>>>();
...
function getCacheKey<TVariables>({ query, ...options }: WatchQueryOptions<TVariables>): string {
